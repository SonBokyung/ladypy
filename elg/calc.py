...
def derive_P_from(A):
    ...
    >>> import numpy as np
    >>> from elg.calc import derive_P_from
...
def derive_Q_from(A):
    ...
    >>> import numpy as np
    >>> from elg.calc import derive_Q_from
...
def payoff_PQ_self(P, Q):
    ...
    >>> import numpy as np
    >>> from elg.calc import derive_P_from, derive_Q_from, payoff_PQ_self
...
def payoff_PQ(P, Q):
    ...
    >>> import numpy as np
    >>> from elg.calc import derive_P_from, derive_Q_from, payoff_PQ
...
def payoff_self(A):
    ...
    >>> import numpy as np
    >>> from elg.calc import derive_P_from, derive_Q_from, payoff_self
...
def payoff(A):
    ...
    :Example:
    >>> import numpy as np
    >>> from elg.calc import derive_P_from, derive_Q_from, payoff
